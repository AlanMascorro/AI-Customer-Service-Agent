...
<script>
 ...
 // var oldy;
  ...
  let urlClient = process.env.VUE_APP_HOST_IP + ":" + process.env.VUE_APP_HOST_PORT + "/api/client";
  ...
  export default {
    ...
    methods: {
      ...
      async sendMessage() {
        ...
        let url = process.env.VUE_APP_HOST_IP + ":" + process.env.VUE_APP_HOST_PORT + `/api/query/${clientID}`;
